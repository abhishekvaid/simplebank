...
// Source: himavisoft.simple_bank/db/sqlc (interfaces: Store)
...
func (m *MockStore) CreateUser(arg0 context.Context, arg1 db.GetUserParams) (db.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfersByFromAccountId(arg0 context.Context, arg1 db.GetTransfersByFromAccountIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
// GetTransfersByFromAndToAccountId mocks base method.
func (m *MockStore) GetTransfersByFromAndToAccountId(arg0 context.Context, arg1 db.GetTransfersByFromAndToAccountIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersByFromAndToAccountId", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersByFromAndToAccountId indicates an expected call of GetTransfersByFromAndToAccountId.
func (mr *MockStoreMockRecorder) GetTransfersByFromAndToAccountId(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersByFromAndToAccountId", reflect.TypeOf((*MockStore)(nil).GetTransfersByFromAndToAccountId), arg0, arg1)
}

// GetTransfersByToAccountId mocks base method.
func (m *MockStore) GetTransfersByToAccountId(arg0 context.Context, arg1 db.GetTransfersByToAccountIdParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
